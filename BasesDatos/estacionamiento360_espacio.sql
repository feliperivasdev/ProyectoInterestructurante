...
CREATE TABLE `espacio` (
  ...
  KEY `espacio-categoria_idx` (`id_Category`),
  KEY `espacio-estado_idx` (`id_State`),
  CONSTRAINT `espacio-categoria` FOREIGN KEY (`id_Category`) REFERENCES `categoria` (`id_categoria`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `espacio-estado` FOREIGN KEY (`id_State`) REFERENCES `estado` (`id estado`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2023-09-03 22:15:20
